...
fitness_router.add_api_route("/fitness/strength/new", controller.new_strength, methods=["GET"])
fitness_router.add_api_route("/fitness/strength", controller.save_strength, methods=["POST"])
fitness_router.add_api_route("/fitness/strength/inputs/details", controller.inputs, methods=["GET"])